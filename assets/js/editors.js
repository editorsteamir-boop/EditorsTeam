      ...
      return `<article class="editor-card">
        <div class="editor-header">
          <div class="editor-avatar-wrap">
            <img class="editor-avatar" src="${escapeText(window.ETThumb?window.ETThumb(editor.image):editor.image)}" alt="تصویر ${escapeText(editor.fullName)}" loading="${editorIndex<2?'eager':'lazy'}" decoding="async" ${editorIndex<2?'fetchpriority="high"':''} onerror="this.onerror=null;this.src='${DEFAULT_AVATAR}'">
