...
const STATIC_CACHE=`${CACHE_PREFIX}static-v18-fonto-pro`;
const PAGE_CACHE=`${CACHE_PREFIX}pages-v18-fonto-pro`;
...
self.addEventListener("fetch",e=>{
  ...
  if(nav){e.respondWith(swr(r,PAGE_CACHE,true));return;}
